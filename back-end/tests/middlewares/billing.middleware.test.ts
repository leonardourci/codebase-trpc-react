...
describe('Billing Middleware', () => {
    ...
    describe('verifyStripeWebhookSignatureMiddleware', () => {
        ...
        it('should log appropriate messages for missing signature', () => {
            ...
            expect(consoleSpy).toHaveBeenCalledWith('⚠️  No Stripe signature found on request')

            consoleSpy.mockRestore()
        })

        it('should log appropriate messages for signature verification failure', () => {
            const consoleSpy = jest.spyOn(console, 'log').mockImplementation()
