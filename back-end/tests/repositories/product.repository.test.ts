...
import { getProductById, getAllProducts, getFreeTierProduct } from '../../src/database/repositories/product.repository'
...
describe('Product Repository', () => {
	...
	describe('getFreeTierProduct', () => {
		...
		it('should throw error when no free tier product exists', async () => {
			...
			await expect(getFreeTierProduct()).rejects.toThrow('Free tier product not found. Update your database seed to mark one product with is_free_tier = true.')
		})
	})
})
