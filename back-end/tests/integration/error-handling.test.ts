...
describe('Error Handling Integration Tests', () => {
	...
	describe('Not Found Error Handling', () => {
		...
		it('should return not found error for non-existent product in checkout session', async () => {
			const nonExistentPriceId = 'price_nonexistent'
	...
	describe('Server Error Handling', () => {
		...
		it('should handle Stripe API errors gracefully', async () => {
			...
			mockStripe.checkout.sessions.create.mockRejectedValueOnce(new Error('Stripe API temporarily unavailable'))
	...
	describe('Error Message Quality', () => {
		...
		it('should provide generic error messages for server errors without exposing internals', async () => {
			...
			mockStripe.checkout.sessions.create.mockRejectedValueOnce(new Error('Internal database connection failed'))
